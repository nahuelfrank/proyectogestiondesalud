...
import { PlusIcon, Siren, TrashIcon, Undo2 } from 'lucide-react';
import { Link } from '@inertiajs/react';
import { z } from 'zod';
import type { PersonaCreatePageProps } from '@/types/personas/persona';
...
export default function PersonaCreatePage({ generos, estadosCiviles, tiposDocumento, claustros, dependenciasAreas, estados }: PersonaCreatePageProps) {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        try {
            // Validar con Zod (valida esquema básico)
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Pacientes | Registrar" />
            ...
            <div className="container mx-auto py-10">
                ...
                <form onSubmit={handleSubmit} className="m-3 space-y-4">
